                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                    <form action="" method="post" enctype="multipart/form-data">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr>
                                <td>Site Email:</td>
                                <td><input name="site_email" value="<?php print $sqli->getSettings('site_email');?>" type="text" class="form-control" placeholder="Site Email"/></td>
                            </tr>
                            <tr>
                                <td>Site Address:</td>
                            ...
                            <tr>
                                <td>Youtube Link:</td>
                                <td><input name="site_youtube" value="<?php print $sqli->getSettings('site_youtube');?>" type="text" class="form-control" placeholder="Youtube Link"/></td>
                            </tr>
                            <tr>
                                <td>Facebook Link:</td>
                                <td><input name="site_facebook" value="<?php print $sqli->getSettings('site_facebook');?>" type="text" class="form-control" placeholder="Facebook Link"/></td>
                            </tr>
                            <tr>
                                <td>Twitter Link:</td>
                                <td><input name="site_twitter" value="<?php print $sqli->getSettings('site_twitter');?>" type="text" class="form-control" placeholder="Twitter Link"/></td>
                            </tr>
                            <tr>
                                <td>Instagram Link:</td>
                                <td><input name="site_instagram" value="<?php print $sqli->getSettings('site_instagram');?>" type="text" class="form-control" placeholder="Instagram Link"/></td>
                            </tr>
                            <tr>
                                <td>Linkedin Link:</td>
                                <td><input name="site_linkedin" value="<?php print $sqli->getSettings('site_linkedin');?>" type="text" class="form-control" placeholder="Linkedin Link"/></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
                                            ...
                                            <textarea class="form-control" value="" name="about" ><?php print $sqli->getSettings('about');?></textarea>
                                </td>
                            </tr>

                            <tr>
                                <td>Mission:</td>
                                <td><textarea class="form-control" value="" name="mission" ><?php print $sqli->getSettings('mission');?></textarea></td>
                            </tr>
                            <tr>
                                <td>Plan:</td>
                                <td><textarea class="form-control" value="" name="plan" ><?php print $sqli->getSettings('plan');?></textarea></td>
                            </tr>
                            <tr>
                                <td>Our Vision:</td>
                                <td><textarea class="form-control" value="" name="vision" ><?php print $sqli->getSettings('vision');?></textarea></td>
                            </tr>

                            <tr>
                                <td>Happy Client:</td>
                                <td><input name="happy_client" value="<?php print $sqli->getSettings('happy_client');?>" type="number" class="form-control"/></td>
                            </tr>

                            <tr>
                                <td>Projects:</td>
                                <td><input name="projects" value="<?php print $sqli->getSettings('projects');?>" type="number" class="form-control"/></td>
                            </tr>

                            <tr>
                                <td>Years of experience:</td>
                                <td><input name="years_of_experience" value="<?php print $sqli->getSettings('years_of_experience');?>" type="number" class="form-control"/></td>
                            </tr>

                            <tr>
                                <td>Awards:</td>
                                <td><input name="awards" value="<?php print $sqli->getSettings('awards');?>" type="number" class="form-control"/></td>
                            </tr>
